...
test1:	slt $t7, $t1, $t0	# check for i < size
	bnez $t7, body1
...
#################################################
	...
	.data
size: 100
bufferMat1: .space 20100		# (2*size + 1)*size
bufferMat2: .space 20100		# (50,5050) (100,20100) (200,80200) (400,320400)
mat1: .asciiz "matrix1.dat"      # filename for matrix B
mat2: .asciiz "matrix2.dat"      # filename for matrix C
endl: .asciiz "\n"
wspace: .asciiz " "
printStart: .asciiz "Starting the matrix addition\n"
printEnd: .asciiz "End of the matrix addition\n"
